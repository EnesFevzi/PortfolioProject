...
namespace PortfolioProject.DataAccess.Migrations
{
    ...
    [Migration("20231030194156_initial5")]
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.About", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(6734),
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a8a3c90d-9d00-433e-8033-68229335e9d6",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d26116a0-e3f3-4842-8b0c-790f0ce7058c",
                            Name = "Admin",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bf3b10d6-6c1f-41c2-a1e1-5bfd3f3ab072",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEek5AxXR2E3VgAQ3p4Rl/MS1shl6GlSaxr1S3t0aXzmKdwN5TCKTl/oruLiLWtIUg==",
                            PhoneNumber = "+905439999999",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "85cf53b8-a9fe-4d49-8350-dadfa4b67c0d",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(7594),
                            DeletedBy = "Enes Fevzi",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(7598),
                            DeletedBy = "Enes Fevzi",
                            EndTime = new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(7677),
                            DeletedBy = "Enes Fevzi",
                            EndTime = new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(7681),
                            DeletedBy = "Enes Fevzi",
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
                            Name = "Eren Brulor",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(7773),
                            DeletedBy = "Enes Fevzi",
                        ...
                        new
                        {
                            ImageID = new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 916, DateTimeKind.Local).AddTicks(7777),
                            DeletedBy = "Enes Fevzi",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Skill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 917, DateTimeKind.Local).AddTicks(256),
                            DeletedBy = "Enes Fevzi",
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
                            Title = "C#",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 30, 22, 41, 55, 917, DateTimeKind.Local).AddTicks(259),
                            DeletedBy = "Enes Fevzi",
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
