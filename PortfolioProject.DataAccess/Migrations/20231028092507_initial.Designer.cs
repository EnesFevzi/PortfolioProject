...
namespace PortfolioProject.DataAccess.Migrations
{
    ...
    [Migration("20231028092507_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.About", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(5111),
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "96d79086-31f8-4ad1-aea6-60cec2d47bf7",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a7f6f71e-896d-4c80-ac6c-6a5a21ac5dd4",
                            Name = "Admin",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0c4e2399-94c1-43e5-b458-c7c029512bd8",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEL5l6E9A3LUyATg0uwBwo0uEBGZ+6XfT6K1zStAp+/MGi9we7r28tKwTtqtLQ9m9uA==",
                            PhoneNumber = "+905439999999",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "b8884a22-24e3-4785-827d-2f53339f1b57",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c1390a89-9259-42d7-addf-895997d85842",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHK/OeKS4nwFTIYwzoY2HFq70NN6W08Wj+F1KFzhaCoO1ACpGNgu1hsawSsk0Pok/g==",
                            PhoneNumber = "+905439999988",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "79b44b14-7b35-454a-8f99-5e3dca02ba86",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(6356),
                            DeletedBy = "Enes Fevzi",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(6362),
                            DeletedBy = "Enes Fevzi",
                            EndTime = new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(6476),
                            DeletedBy = "Enes Fevzi",
                            EndTime = new DateTime(2023, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(6483),
                            DeletedBy = "Enes Fevzi",
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
                            Name = "Eren Brulor",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(6581),
                            DeletedBy = "Enes Fevzi",
                        ...
                        new
                        {
                            ImageID = new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 611, DateTimeKind.Local).AddTicks(6584),
                            DeletedBy = "Enes Fevzi",
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Project", b =>
                {
            ...
            modelBuilder.Entity("PortfolioProject.Entity.Entities.Skill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 612, DateTimeKind.Local).AddTicks(1045),
                            DeletedBy = "Enes Fevzi",
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
                            Title = "C#",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "SuperAdmin",
                            CreatedDate = new DateTime(2023, 10, 28, 12, 25, 7, 612, DateTimeKind.Local).AddTicks(1049),
                            DeletedBy = "Enes Fevzi",
                            IsDeleted = false,
                            ModifiedBy = "Enes Fevzi",
